...
test('status of specified task should be changed', () => {
    const model = {taskId: "2", model: {status: TaskStatuses.New}, todolistId: "todolistId2"}
    const action = updateTaskTC.fulfilled(model, '', model);
...
test('new array should be added when new todolist is added', () => {
    ...
    const action = addTodolistTC.fulfilled(payload, '', payload.title);
